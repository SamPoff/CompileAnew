...
for_loop = Rule('((FOR)(LP)(STATEMENT)(E)(SEMICOLON)(((IDENTIFIER)(EQUALSIGN)(E))|(UE))(RP)(LB)(STATEMENT)*?(RB)|'
                 '(FOR)(LP)(STATEMENT)(E)(SEMICOLON)(((IDENTIFIER)(EQUALSIGN)(E))|(UE))(RP)(STATEMENT|SEMICOLON))', 'STATEMENT', 'FOR_LOOP', None)

# while( expression ){}
while_loop = Rule('((WHILE)(LP)(E|UE|NUMBER|IDENTIFIER)(RP)(LB)(STATEMENT)*?(RB)|'
                         '(WHILE)(LP)(E|UE|NUMBER|IDENTIFIER)(RP)(STATEMENT))', 'STATEMENT', 'WHILE_LOOP', None)
